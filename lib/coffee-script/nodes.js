...
(function() {
  ...
  exports.Base = Base = (function() {
    ...
    Base.prototype.compileToFragments = function(o, lvl, isolated) {
      var node;
      o = extend({}, o);
      if (lvl) {
        o.level = lvl;
  ...
  exports.Call = Call = (function(superClass1) {
    ...
    function Call(variable1, args1, soak, isolated1, func1) {
      this.variable = variable1;
      this.args = args1 != null ? args1 : [];
      this.soak = soak != null ? soak : false;
      this.isolated = isolated1 != null ? isolated1 : false;
      this.func = func1;
      this.isNew = false;
    ...
    Call.prototype.compileNode = function(o) {
      var arg, argIndex, code, compiledArgs, compiledArray, fragments, j, len1, preface, ref3, ref4, vr;
      ...
      if (this instanceof SuperCall) {
        ...
        if (this.isolated) {
          code = this.variable.compileToFragments(o, LEVEL_TOP, true);
          vr = o.scope.root.freeVariable('isolatedFn');
          o.scope.root.assign(vr, fragmentsToText(code));
          fragments.push(this.makeCode(vr));
        } else {
          code = this.variable.compileToFragments(o, LEVEL_ACCESS);
          fragments.push.apply(fragments, code);
        }
        fragments.push(this.makeCode("("));
      }
  ...
  exports.Op = Op = (function(superClass1) {
    ...
    function Op(op, first, second, flip) {
      ...
      if (op === 'do' || op === 'isolate') {
        return this.generateDo(first, op === 'isolate');
      }
      if (op === 'new') {
    ...
    Op.prototype.generateDo = function(exp, isolated) {
